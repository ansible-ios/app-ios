...
All notable changes to Ansible for iOS will be documented in this
file.

This changelog covers only modifications made by the Ansible iOS
...
[Unreleased]: https://github.com/ansible-ios/Telegram-iOS/compare/v0.0.0...HEAD
