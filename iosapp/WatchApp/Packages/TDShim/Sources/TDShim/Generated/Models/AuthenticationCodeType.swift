...
public indirect enum AuthenticationCodeType: Codable, Equatable, Hashable {
    ...
    /// A digit-only authentication code is delivered via a private Iosapp message, which can be viewed from another active session
    case authenticationCodeTypeIosappMessage(AuthenticationCodeTypeIosappMessage)
    ...
    private enum Kind: String, Codable {
        case authenticationCodeTypeIosappMessage
    ...
    public init(from decoder: Decoder) throws {
        ...
        switch type {
        case .authenticationCodeTypeIosappMessage:
            let value = try AuthenticationCodeTypeIosappMessage(from: decoder)
            self = .authenticationCodeTypeIosappMessage(value)
        case .authenticationCodeTypeSms:
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .authenticationCodeTypeIosappMessage(let value):
            try container.encode(Kind.authenticationCodeTypeIosappMessage, forKey: .type)
...
/// A digit-only authentication code is delivered via a private Iosapp message, which can be viewed from another active session
public struct AuthenticationCodeTypeIosappMessage: Codable, Equatable, Hashable {
