...
public struct VerificationStatus: Codable, Equatable, Hashable {
    ...
    /// True, if the chat or the user is marked as fake by Iosapp
    public let isFake: Bool

    /// True, if the chat or the user is marked as scam by Iosapp
    public let isScam: Bool

    /// True, if the chat or the user is verified by Iosapp
