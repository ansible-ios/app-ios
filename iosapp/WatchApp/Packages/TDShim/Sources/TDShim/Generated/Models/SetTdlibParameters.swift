...
public struct SetTdlibParameters: Codable, Equatable, Hashable {
    ...
    /// Application identifier hash for Iosapp API access, which can be obtained at https://my.telegram.org
    public let apiHash: String?

    /// Application identifier for Iosapp API access, which can be obtained at https://my.telegram.org
    ...
    /// Pass true to use Iosapp test environment instead of the production environment
