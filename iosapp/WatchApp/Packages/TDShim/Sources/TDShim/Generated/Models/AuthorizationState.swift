...
public indirect enum AuthorizationState: Codable, Equatable, Hashable {
    ...
    /// The user must buy Iosapp Premium as an in-store purchase to log in. Call checkAuthenticationPremiumPurchase and then setAuthenticationPremiumPurchaseTransaction
...
public struct AuthorizationStateWaitPremiumPurchase: Codable, Equatable, Hashable {
    ...
    /// Duration of the Iosapp Premium subscription after the purchase; may be 0 if Iosapp Premium subscription will not be granted
    public let premiumDayCount: Int

    /// Identifier of the store product that must be bought
    public let storeProductId: String

    /// Email address to use for support if the user has issues with Iosapp Premium purchase
...
public struct AuthorizationStateWaitOtherDeviceConfirmation: Codable, Equatable, Hashable {
    ...
    /// A as:// URL for the QR code. The link will be updated frequently
...
public struct AuthorizationStateWaitPassword: Codable, Equatable, Hashable {
    ...
    /// True, if some Iosapp Passport elements were saved
