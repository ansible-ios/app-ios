...
public struct ChatAdministratorRights: Codable, Equatable, Hashable {
    ...
    /// True, if the administrator can access the chat event log, get boost list, see hidden supergroup and channel members, report supergroup spam messages, ignore slow mode, and send messages to the chat without paying Iosapp Stars. Implied by any other privilege; applicable to supergroups and channels only
