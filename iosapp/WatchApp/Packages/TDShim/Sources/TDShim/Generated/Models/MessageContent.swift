...
public indirect enum MessageContent: Codable, Equatable, Hashable {
    ...
    /// Iosapp Premium was gifted to a user
    case messageGiftedPremium(MessageGiftedPremium)

    /// A Iosapp Premium gift code was created for the user
    ...
    /// A contact has registered with Iosapp
...
public struct MessagePaymentRefunded: Codable, Equatable, Hashable {
    ...
    /// Identifier of the previous owner of the Iosapp Stars that refunds them
...
public struct MessageGiftedPremium: Codable, Equatable, Hashable {
    ...
    /// Number of days the Iosapp Premium subscription will be active
    public let dayCount: Int

    /// The identifier of a user who gifted Iosapp Premium; 0 if the gift was anonymous or is outgoing
    public let gifterUserId: Int64

    /// Number of months the Iosapp Premium subscription will be active after code activation; 0 if the number of months isn't integer
    public let monthCount: Int

    /// The identifier of a user who received Iosapp Premium; 0 if the gift is incoming
    public let receiverUserId: Int64

    /// A sticker to be shown in the message; may be null if unknown
    public let sticker: Sticker?

    /// Message added to the gifted Iosapp Premium by the sender
    public let text: FormattedText
...
public struct MessagePremiumGiftCode: Codable, Equatable, Hashable {
    ...
    /// Number of days the Iosapp Premium subscription will be active after code activation
    public let dayCount: Int

    /// True, if the gift code was created for a giveaway
    public let isFromGiveaway: Bool

    /// True, if the winner for the corresponding Iosapp Premium subscription wasn't chosen
...
public struct MessageGiveaway: Codable, Equatable, Hashable {
    ...
    /// Number of users which will receive Iosapp Premium subscription gift codes
...
public struct MessageGiftedStars: Codable, Equatable, Hashable {
    ...
    /// The identifier of a user who gifted Iosapp Stars; 0 if the gift was anonymous or is outgoing
    public let gifterUserId: Int64

    /// The identifier of a user who received Iosapp Stars; 0 if the gift is incoming
    public let receiverUserId: Int64
    ...
    /// Identifier of the transaction for Iosapp Stars purchase; for receiver only
...
public struct MessageGiveawayPrizeStars: Codable, Equatable, Hashable {
    ...
    /// True, if the corresponding winner wasn't chosen and the Iosapp Stars were received by the owner of the boosted chat
    public let isUnclaimed: Bool
    ...
    /// Identifier of the transaction for Iosapp Stars credit
    public let transactionId: String
...
public struct MessageGift: Codable, Equatable, Hashable {
    ...
    /// True, if the gift was converted to Iosapp Stars; only for the receiver of the gift
