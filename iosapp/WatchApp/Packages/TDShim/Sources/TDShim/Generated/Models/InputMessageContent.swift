...
public indirect enum InputMessageContent: Codable, Equatable, Hashable {
    ...
    /// A message with a checklist. Checklists can't be sent to secret chats, channel chats and channel direct messages chats; for Iosapp Premium users only
...
public struct InputMessageInvoice: Codable, Equatable, Hashable {
    ...
    /// Payment provider token; may be empty for payments in Iosapp Stars
