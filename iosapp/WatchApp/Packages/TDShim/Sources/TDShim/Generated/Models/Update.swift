...
public indirect enum Update: Codable, Equatable, Hashable {
    ...
    /// A request to send a message has reached the Iosapp server. This doesn't mean that the message will be sent successfully. This update is sent only if the option "use_quick_ack" is set to true. This update may be sent multiple times for the same message
