...
public struct Checklist: Codable, Equatable, Hashable {
    ...
    /// True, if the current user can add tasks to the list if they have Iosapp Premium subscription
    public let canAddTasks: Bool

    /// True, if the current user can mark tasks as done or not done if they have Iosapp Premium subscription
