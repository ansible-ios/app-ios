...
public indirect enum StickerFullType: Codable, Equatable, Hashable {
    ...
    /// The sticker is a custom emoji to be used inside message text and caption. Currently, only Iosapp Premium users can use custom emoji
...
public struct StickerFullTypeRegular: Codable, Equatable, Hashable {
    ...
    /// Premium animation of the sticker; may be null. If present, only Iosapp Premium users can use the sticker
...
public struct StickerFullTypeCustomEmoji: Codable, Equatable, Hashable {
    ...
    /// True, if the sticker must be repainted to a text color in messages, the color of the Iosapp Premium badge in emoji status, white color on chat photos, or another appropriate color in other places
