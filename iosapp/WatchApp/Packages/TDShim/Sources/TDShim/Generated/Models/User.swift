...
public struct User: Codable, Equatable, Hashable, Identifiable {
    ...
    /// Emoji status to be shown instead of the default Iosapp Premium badge; may be null
    ...
    /// True, if the user is a Iosapp Premium user
    public let isPremium: Bool

    /// True, if the user is Iosapp support account
