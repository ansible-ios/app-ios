...
public class TDLibApi {
    ...
    /// - Parameter apiHash: Application identifier hash for Iosapp API access, which can be obtained at https://my.telegram.org
    /// - Parameter apiId: Application identifier for Iosapp API access, which can be obtained at https://my.telegram.org
    ...
    /// - Parameter useTestDc: Pass true to use Iosapp test environment instead of the production environment
