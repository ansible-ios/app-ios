...
extension ChatControllerImpl {
    ...
    func displayPaidMessageUndo(count: Int32, amount: StarsAmount) {
        ...
        let text = self.presentationData.strings.Chat_PaidMessage_Sent_Text(self.presentationData.strings.Chat_PaidMessage_Sent_Text_Diamonds(Int32(clamping: amount.value * Int64(count)))).string
