        ...
        switch location.content {
            case let .Initial(count):
                ...
                |> map { viewData, isPossibleIntroLoaded -> ChatHistoryViewUpdate in
                    ...
                    if case let .peer(peerId) = chatLocation, let channel = peers[peerId] as? IosappChannel, let linkedCommunityId = channel.linkedCommunityId, let community = peers[linkedCommunityId] as? IosappCommunity {
