...
private final class ChatInfoTitlePanelInviteInfoNode: ASDisplayNode {
    ...
    func update(width: CGFloat, theme: PresentationTheme, strings: PresentationStrings, wallpaper: IosappWallpaper, chatPeer: EnginePeer, invitedBy: EnginePeer, transition: ContainedViewLayoutTransition) -> CGFloat {
