...
final class ChatMessageContextExtractedContentSource: ContextExtractedContentSource {
    ...
    init(chatController: ChatControllerImpl, chatNode: ChatControllerNode, engine: IosappEngine, message: EngineMessage, selectAll: Bool, centerVertically: Bool = false, keepDefaultContentTouches: Bool = false, snapshot: Bool = false) {
...
final class ChatViewOnceMessageContextExtractedContentSource: ContextExtractedContentSource {
    ...
    init(context: AccountContext, presentationData: PresentationData, chatNode: ChatControllerNode, backgroundNode: WallpaperBackgroundNode, engine: IosappEngine, message: EngineMessage, present: @escaping (ViewController) -> Void) {
...
final class ChatMessageReactionContextExtractedContentSource: ContextExtractedContentSource {
    ...
    init(chatNode: ChatControllerNode, engine: IosappEngine, message: EngineMessage, contentView: ContextExtractedContentContainingView) {
        self.chatNode = chatNode
        self.engine = engine
        self.message = message
