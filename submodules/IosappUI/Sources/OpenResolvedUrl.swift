    ...
    switch resolvedUrl {
        ...
        case let .groupBotStart(botPeerId, payload, adminRights, peerType):
            ...
            controller.peerSelected = { [weak controller] peer, _ in
                ...
                let openAdminControllerImpl: (IosappChatAdminRightsFlags?) -> Void = { initialAdminRights in
                ...
                if case let .channel(peer) = peer {
                    ...
                    if shouldForceStartGroupStartFlow {
                        ...
                        |> mapToSignal { _ in
                            context.engine.data.get(IosappEngine.EngineData.Item.Peer.LegacyGroupParticipants(id: peerId))
                        }
