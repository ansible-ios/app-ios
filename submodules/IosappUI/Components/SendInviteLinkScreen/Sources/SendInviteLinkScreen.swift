...
private func sendInviteLinkHasInviteSection(subject: SendInviteLinkScreenSubject, peers: [IosappForbiddenInvitePeer]) -> Bool {
...
final class SendInviteLinkScreenComponent: Component {
    ...
    final class View: UIView {
        ...
        private func sendInviteLink(link: String, selectedPeers: [IosappForbiddenInvitePeer], completion: (() -> Void)? = nil) {
