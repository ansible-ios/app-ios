...
private func communityChatPreviewSignal(context: AccountContext, peerId: EnginePeer.Id) -> Signal<(EnginePeer.Id, CommunityChatPreviewData), NoError> {
    ...
    return combineLatest(
        ...
        context.engine.data.subscribe(IosappEngine.EngineData.Item.Messages.PeerReadCounters(id: peerId)),
...
private func communityChatCanRemovePeer(community: IosappCommunity?, peer: EnginePeer) -> Bool {
        ...
        private func ensureDataSignal(component: CommunityViewScreenComponent) {
            if self.dataDisposable == nil {
                self.dataDisposable = (component.context.engine.data.subscribe(
                    IosappEngine.EngineData.Item.Peer.Peer(id: component.communityId),
                    IosappEngine.EngineData.Item.Peer.CachedData(id: component.communityId)
                )
