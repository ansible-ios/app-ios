...
public class RichTextAttachmentScreen: ViewControllerComponentContainer, AttachmentContainable {
    ...
    public enum Mode {
        case standalone(savedDraft: Document?, media: [String: Media], emojiFiles: [Int64: IosappMediaFile])
        case edit(initialDocument: Document?, media: [String: Media], emojiFiles: [Int64: IosappMediaFile])
    }
    ...
    private let sendMessage: (Document, [String: Media], [Int64: IosappMediaFile], Bool) -> Void
    private let syncContent: ((Document, [String: Media], [Int64: IosappMediaFile]) -> Void)?

    public convenience init(
        context: AccountContext,
        mode: Mode,
        sendMessage: @escaping (Document, [String: Media], [Int64: IosappMediaFile]) -> Void,
        syncContent: ((Document, [String: Media], [Int64: IosappMediaFile]) -> Void)? = nil,
    ...
    public init(
        context: AccountContext,
        mode: Mode,
        sendMessage: @escaping (Document, [String: Media], [Int64: IosappMediaFile], Bool) -> Void,
        syncContent: ((Document, [String: Media], [Int64: IosappMediaFile]) -> Void)? = nil,
        presentAttachmentMenu: ((_ photoVideoOnly: Bool, @escaping (RichTextAttachmentScreen.RichTextAttachment) -> Void) -> Void)?,
        presentFormulaEditor: ((_ initialValue: String?, _ completion: @escaping (String) -> Void) -> Void)?
    ) {
...
final class RichTextAttachmentScreenComponent: Component {
    ...
    final class View: UIView {
        ...
        /// `donePressed` so each emoji run's `IosappMediaFile` is re-attached when converting back.
        var currentEmojiFiles: [Int64: IosappMediaFile] {
        ...
        func update(component: RichTextAttachmentScreenComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<EnvironmentType>, transition: ComponentTransition) -> CGSize {
            ...
            if self.component == nil {
                ...
                var initialEmojiFiles: [Int64: IosappMediaFile] = [:]
