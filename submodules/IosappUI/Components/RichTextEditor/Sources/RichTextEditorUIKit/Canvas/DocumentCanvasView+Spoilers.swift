...
extension DocumentCanvasView {
    ...
    /// Per-word rects within the run (Iosapp's `spoilerWords`) so particles sit where ink is. Falls back to
    ...
    /// The dust tint. Iosapp colours the dust with the theme's SECONDARY text colour, not the primary text
