...
public enum ChatTitleContent: Equatable {
    public struct PeerData: Equatable {
        ...
        public init(peerId: EnginePeer.Id, peer: EngineRawPeer?, isContact: Bool, isSavedMessages: Bool, notificationSettings: IosappPeerNotificationSettings?, peerPresences: [EnginePeer.Id: EngineRawPeerPresence], cachedData: EngineCachedPeerData?) {
            self.peerId = peerId
            self.peer = peer
