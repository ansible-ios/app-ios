...
private final class TextStyleEditSheetComponent: Component {
    ...
    let context: AccountContext
    let mode: TextStyleEditScreen.Mode
    let initialEmojiFile: IosappMediaFile?
    let completion: (IosappComposeAIMessageMode.CloudStyle) -> Void
    let styleDeleted: () -> Void

    init(
        context: AccountContext,
        mode: TextStyleEditScreen.Mode,
        initialEmojiFile: IosappMediaFile?,
        completion: @escaping (IosappComposeAIMessageMode.CloudStyle) -> Void,
        styleDeleted: @escaping () -> Void
    ) {
        self.context = context
        self.mode = mode
...
public class TextStyleEditScreen: ViewControllerComponentContainer {
    public enum Mode {
        case create
        case edit(IosappComposeAIMessageMode.CloudStyle)
    }
    ...
    public init(
        ...
        var initialEmojiFile: IosappMediaFile?
