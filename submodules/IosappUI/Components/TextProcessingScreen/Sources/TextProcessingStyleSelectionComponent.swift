...
final class TextProcessingStyleSelectionComponent: Component {
    ...
    let updateStyle: (IosappComposeAIMessageMode.StyleReference) -> Void
    ...
    init(
        ...
        updateStyle: @escaping (IosappComposeAIMessageMode.StyleReference) -> Void,
    ...
    final class View: UIView {
        ...
        private var itemWithActiveContextGesture: IosappComposeAIMessageMode.StyleId?
        ...
        private func item(at point: CGPoint) -> (id: IosappComposeAIMessageMode.StyleId, itemView: ComponentView<Empty>)? {
