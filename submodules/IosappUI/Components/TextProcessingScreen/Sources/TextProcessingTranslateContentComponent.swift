...
final class TextProcessingTranslateContentComponent: Component {
    ...
    final class ExternalState {
        ...
        fileprivate(set) var style: IosappComposeAIMessageMode.StyleReference = .neutral
    ...
    let openStyleContextMenu: (IosappComposeAIMessageMode.StyleReference, ContextGesture, ContextExtractedContentContainingView) -> Void
    ...
    init(
        ...
        openStyleContextMenu: @escaping (IosappComposeAIMessageMode.StyleReference, ContextGesture, ContextExtractedContentContainingView) -> Void,
