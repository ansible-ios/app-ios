                        ...
                        updateSearchQuery: { [weak self] query in
                            ...
                            case let .text(rawQuery, languageCode):
                                ...
                                if query.isEmpty {
                                    ...
                                    let installedPackIds = context.engine.data.subscribe(IosappEngine.EngineData.Item.ItemCollections.InstalledPackInfos(namespace: Namespaces.ItemCollection.CloudStickerPacks))
