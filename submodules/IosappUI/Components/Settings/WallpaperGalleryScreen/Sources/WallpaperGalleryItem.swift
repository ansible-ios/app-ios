...
private func reference(for resource: IosappMediaResource, media: EngineRawMedia, message: EngineRawMessage?, slug: String?) -> MediaResourceReference {
            ...
            switch entry {
                ...
                case let .contextResult(result):
                    ...
                    if let imageResource = imageResource, let imageDimensions = imageDimensions {
                        ...
                        let tmpImage = IosappMediaImage(imageId: EngineMedia.Id(namespace: 0, id: 0), representations: representations, immediateThumbnailData: nil, reference: nil, partialReference: nil, flags: [])
