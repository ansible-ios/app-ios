...
public enum WallpaperListSource {
    ...
    case wallpaper(IosappWallpaper, WallpaperPresentationOptions?, [UInt32], Int32?, Int32?, EngineRawMessage?)
    case slug(String, IosappMediaFile?, WallpaperPresentationOptions?, [UInt32], Int32?, Int32?, EngineRawMessage?)
    case asset(PHAsset)
...
public enum WallpaperGalleryEntry: Equatable {
    case wallpaper(IosappWallpaper, EngineRawMessage?)
    case asset(PHAsset)
    case contextResult(ChatContextResult)
