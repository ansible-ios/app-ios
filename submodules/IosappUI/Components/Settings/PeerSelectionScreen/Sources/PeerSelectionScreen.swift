...
public final class PeerSelectionScreen: ViewControllerComponentContainer {
    ...
    public final class InitialData {
        ...
        init(channelId: EnginePeer.Id?, channels: [IosappAdminedPublicChannel]?, mode: Mode) {
    ...
    public static func communityInitialData(channels: [IosappAdminedPublicChannel]) -> InitialData {
