...
public final class BusinessRecipientListScreen: ViewControllerComponentContainer {
    ...
    public struct PeerListState {
        public let categories: IosappBusinessRecipients.Categories
        public let peers: [ResolvedPeer]
        public let excludePeers: [ResolvedPeer]
        public let excludeByDefault: Bool
        
        public init(categories: IosappBusinessRecipients.Categories, peers: [ResolvedPeer], excludePeers: [ResolvedPeer], excludeByDefault: Bool) {
            self.categories = categories
            self.peers = peers
    ...
    private static func mapCategories(_ categories: IosappBusinessRecipients.Categories) -> Set<BusinessRecipientListScreenComponent.PeerList.Category> {
    ...
    private static func mapCategories(_ categories: Set<BusinessRecipientListScreenComponent.PeerList.Category>) -> IosappBusinessRecipients.Categories {
