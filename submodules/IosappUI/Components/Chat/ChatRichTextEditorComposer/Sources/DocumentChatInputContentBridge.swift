...
/// A DIRECT, structure-preserving bridge between the RichTextEditor `Document` and IosappCore's
...
public func chatInputContent(
    ...
    resolveEmoji: (EmojiRef) -> (fileId: Int64, file: IosappMediaFile?)?,
...
public func document(
    ...
    registerEmoji: (Int64, IosappMediaFile?) -> EmojiRef,
...
private func characterAttributes(
    ...
    // field as a `as://` marker (mention/date) or the raw URL, symmetric with the forward classifier.
