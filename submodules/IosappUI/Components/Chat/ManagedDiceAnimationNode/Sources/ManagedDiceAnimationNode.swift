...
public final class ManagedDiceAnimationNode: ManagedAnimationNode {
    ...
    public init(context: AccountContext, emoji: String) {
        ...
        self.configuration.set(self.context.engine.data.subscribe(IosappEngine.EngineData.Item.Configuration.ApplicationSpecificPreference(key: PreferencesKeys.appConfiguration))
