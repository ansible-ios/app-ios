    ...
    final class View: UIView {
        ...
        private func updateCommunityBanContext(component: AdminUserActionsSheetComponent) {
            ...
            let signal = combineLatest(
                component.context.engine.data.get(IosappEngine.EngineData.Item.Peer.Peer(id: communityId)),
            ...
            |> mapToSignal { communityPeer, participant, joinedChats -> Signal<(EnginePeer?, ChannelParticipant?, CommunityParticipantJoinedChats, [EnginePeer.Id: Int32]), NoError> in
                ...
                return component.context.engine.data.get(EngineDataMap(
                    joinedChats.creatorChatIds.map(IosappEngine.EngineData.Item.Peer.ParticipantCount.init)
                ))
...
public class AdminUserActionsSheet: ViewControllerComponentContainer {
    ...
    public final class ChatResult {
        ...
        init(reportSpamPeers: [EnginePeer.Id], deleteAllFromPeers: [EnginePeer.Id], deleteAllReactionsFromPeers: [EnginePeer.Id], banPeers: [EnginePeer.Id], updateBannedRights: [EnginePeer.Id: IosappChatBannedRights], banFromCommunity: CommunityBanResult?) {
