...
public final class ChatControllerInteraction: ChatControllerInteractionProtocol {
    ...
    public let displayPremiumStickerTooltip: (IosappMediaFile, EngineRawMessage) -> Void
    public let displayEmojiPackTooltip: (IosappMediaFile, EngineRawMessage) -> Void
    ...
    public let commitEmojiInteraction: (EngineMessage.Id, String, EmojiInteraction, IosappMediaFile) -> Void
    ...
    public init(
        ...
        displayPremiumStickerTooltip: @escaping (IosappMediaFile, EngineRawMessage) -> Void,
        displayEmojiPackTooltip: @escaping (IosappMediaFile, EngineRawMessage) -> Void,
        ...
        commitEmojiInteraction: @escaping (EngineMessage.Id, String, EmojiInteraction, IosappMediaFile) -> Void,
