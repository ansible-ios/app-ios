...
public struct ApplicationSpecificNotice {
    ...
    public static func setIrrelevantPeerGeoReport(engine: IosappEngine, peerId: EnginePeer.Id) -> Signal<Never, NoError> {
    ...
    public static func getBotPaymentLiability(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Bool, NoError> {
    ...
    public static func setBotPaymentLiability(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Void, NoError> {
    ...
    public static func getBotGameNotice(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setBotGameNotice(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = EngineCodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func getInlineBotLocationRequest(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Int32?, NoError> {
    ...
    public static func inlineBotLocationRequestStatus(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Bool, NoError> {
    ...
    public static func updateInlineBotLocationRequestState(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id, timestamp: Int32) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setInlineBotLocationRequest(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id, value: Int32) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
    ...
    public static func getPsaAcknowledgment(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Bool, NoError> {
        return accountManager.transaction { transaction -> Bool in
    ...
    public static func setPsaAcknowledgment(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = EngineCodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func dismissedInvitationRequests(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<[Int64]?, NoError> {
    ...
    public static func setDismissedInvitationRequests(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id, values: [Int64]) -> Signal<Void, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = EngineCodableEntry(ApplicationSpecificInt64ArrayNotice(values: values)) {
    ...
    public static func dismissedPremiumGiftSuggestion(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Int32?, NoError> {
    ...
    public static func incrementDismissedPremiumGiftSuggestion(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id, timestamp: Int32) -> Signal<Never, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = EngineCodableEntry(ApplicationSpecificTimestampNotice(value: timestamp)) {
    ...
    public static func groupEmojiPackSuggestion(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Int32, NoError> {
    ...
    public static func incrementGroupEmojiPackSuggestion(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id, count: Int32 = 1) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
            var currentValue: Int32 = 0
    ...
    public static func dismissedBirthdayPremiumGiftTip(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Int32?, NoError> {
    ...
    public static func incrementDismissedBirthdayPremiumGiftTip(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id, timestamp: Int32) -> Signal<Never, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = EngineCodableEntry(ApplicationSpecificTimestampNotice(value: timestamp)) {
    ...
    public static func displayedPeerVerification(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Bool, NoError> {
    ...
    public static func setDisplayedPeerVerification(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Never, NoError> {
        return accountManager.transaction { transaction -> Void in
            if let entry = EngineCodableEntry(ApplicationSpecificBoolNotice()) {
    ...
    public static func dismissedPaidMessageWarningNamespace(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id) -> Signal<Int64?, NoError> {
    ...
    public static func setDismissedPaidMessageWarningNamespace(accountManager: AccountManager<IosappAccountManagerTypes>, peerId: EnginePeer.Id, amount: Int64?) -> Signal<Never, NoError> {
        return accountManager.transaction { transaction -> Void in
    ...
    public static func getGuestChatMessageTooltip(accountManager: AccountManager<IosappAccountManagerTypes>) -> Signal<Int32, NoError> {
        return accountManager.transaction { transaction -> Int32 in
    ...
    public static func incrementGuestChatMessageTooltip(accountManager: AccountManager<IosappAccountManagerTypes>, count: Int = 1) -> Signal<Int, NoError> {
        return accountManager.transaction { transaction -> Int in
            var currentValue: Int32 = 0
            if let value = transaction.getNotice(ApplicationSpecificNoticeKeys.guestChatMessageTooltip())?.get(ApplicationSpecificCounterNotice.self) {
                currentValue = value.value
