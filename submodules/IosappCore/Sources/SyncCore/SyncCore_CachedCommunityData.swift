...
public final class CachedCommunityData: CachedPeerData {
    ...
    public init(decoder: PostboxDecoder) {
        ...
        self.photo = decoder.decodeObjectForKey("ph", decoder: { IosappMediaImage(decoder: $0) }) as? IosappMediaImage
    ...
    public func withUpdatedPhoto(_ photo: IosappMediaImage?) -> CachedCommunityData {
