...
public enum IosappMediaWebpageAttribute: PostboxCoding, Equatable {
    ...
    public init(decoder: PostboxDecoder) {
        ...
        case IosappMediaWebpageAttributeTypes.aiTextStyle.rawValue:
            self = .aiTextStyle(decoder.decodeObjectForKey("a", decoder: { IosappMediaWebpageAITextStyleAttribute(decoder: $0) }) as! IosappMediaWebpageAITextStyleAttribute)
        default:
            self = .unsupported
        }
    }
    ...
    public func encode(_ encoder: PostboxEncoder) {
        ...
        case let .aiTextStyle(attribute):
            encoder.encodeInt32(IosappMediaWebpageAttributeTypes.aiTextStyle.rawValue, forKey: "r")
            encoder.encodeObject(attribute, forKey: "a")
        }
    }
...
public final class IosappMediaWebpageAITextStyleAttribute: PostboxCoding, Equatable {
    public static func == (lhs: IosappMediaWebpageAITextStyleAttribute, rhs: IosappMediaWebpageAITextStyleAttribute) -> Bool {
