...
public extension IosappEngine.EngineData.Item {
    ...
    enum OrderedLists {
        public struct NewBotConnectionReviews: IosappEngineDataItem, PostboxViewDataItem {
    ...
    enum ItemCollections {
        public struct InstalledPackInfos: IosappEngineDataItem, PostboxViewDataItem {
        ...
        public struct InstalledPackIds: IosappEngineDataItem, PostboxViewDataItem {
