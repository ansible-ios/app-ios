...
public extension IosappEngine.EngineData.Item {
    enum Configuration {
        ...
        public struct ContactsSettings: IosappEngineDataItem, PostboxViewDataItem {
            public typealias Result = IosappCore.ContactsSettings
            ...
            func extract(view: PostboxView) -> Result {
                ...
                guard let value = view.values[PreferencesKeys.contactsSettings]?.get(IosappCore.ContactsSettings.self) else {
                    return IosappCore.ContactsSettings.defaultSettings
                }
                return value
            }
        }
