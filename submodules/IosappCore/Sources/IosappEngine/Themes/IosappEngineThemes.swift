...
public extension IosappEngine {
    final class Themes {
        ...
        public func themes(accountManager: AccountManager<IosappAccountManagerTypes>, forceUpdate: Bool = false) -> Signal<[IosappTheme], NoError> {
        ...
        public func wallpapers(forceUpdate: Bool = false) -> Signal<[IosappWallpaper], NoError> {
