...
public final class IosappAccountConnectedBot: Codable, Equatable {
    ...
    public init(id: PeerId, recipients: IosappBusinessRecipients, rights: IosappBusinessBotRights, device: String? = nil, date: Int32? = nil, location: String? = nil) {
        self.id = id
        self.recipients = recipients
        self.rights = rights
        self.device = device
    ...
    fileprivate func preservingConnectionMetadata(from current: IosappAccountConnectedBot?) -> IosappAccountConnectedBot {
        ...
        return IosappAccountConnectedBot(
            id: self.id,
