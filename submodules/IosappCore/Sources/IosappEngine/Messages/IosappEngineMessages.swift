...
public extension IosappEngine {
    final class Messages {
        ...
        public func composeMessageWithAI(text: String, entities: [MessageTextEntity], proofread: Bool = false, translateToLang: String? = nil, changeStyle: IosappComposeAIMessageMode.CloudStyle.Reference? = nil, emojify: Bool = false) -> Signal<(String, [MessageTextEntity]), TranslationError> {
        ...
        public func composeRichMessageWithAI(instantPage: InstantPage?, proofread: Bool = false, translateToLang: String? = nil, changeStyle: IosappComposeAIMessageMode.CloudStyle.Reference? = nil, customPrompt: String? = nil, emojify: Bool = false) -> Signal<InstantPage, TranslationError> {
        ...
        public func createAITextStyle(displayAuthor: Bool, emojiFileId: Int64, title: String, prompt: String) -> Signal<IosappComposeAIMessageMode.CloudStyle, CreateAITextStyleError> {
        ...
        public func editAITextStyle(id: Int64, accessHash: Int64, displayAuthor: Bool, emojiFileId: Int64, title: String, prompt: String) -> Signal<IosappComposeAIMessageMode.CloudStyle, EditAITextStyleError> {
        ...
        public func getAIComposeToneExample(slug: String, num: Int32) -> Signal<IosappAIComposeToneExample?, NoError> {
            return _internal_getAIComposeToneExample(network: self.account.network, slug: slug, num: num)
        }

        public func getAIComposeToneExample(reference: IosappComposeAIMessageMode.CloudStyle.Reference, num: Int32) -> Signal<IosappAIComposeToneExample?, NoError> {
        ...
        public func composeAIMessageStyles() -> Signal<[IosappComposeAIMessageMode.CloudStyle], NoError> {
        ...
        public func requestAIMessageStyle(slug: String) -> Signal<(style: IosappComposeAIMessageMode.CloudStyle, initialPreview: AIMessageStylePreview?)?, NoError> {
            return _internal_requestAIMessageStyle(account: self.account, slug: slug)
        }
        
        public func installAIMessageStyle(style: IosappComposeAIMessageMode.CloudStyle.Custom) -> Signal<Never, InstallAIMessageStyleError> {
            return _internal_installAIMessageStyle(account: self.account, style: style)
        }
        
        public func composeAIMessage(text: ComposedRichMessage, mode: IosappComposeAIMessageMode) -> Signal<IosappAIComposeMessageResult, IosappAIComposeMessageError> {
            return _internal_composeAIMessage(account: self.account, text: text, mode: mode)
        }
        
        public func requestAIMessageStylePreview(reference: IosappComposeAIMessageMode.CloudStyle.Reference, index: Int) -> Signal<AIMessageStylePreview?, NoError> {
