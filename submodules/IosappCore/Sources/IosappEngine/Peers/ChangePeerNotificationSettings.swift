...
public func resolvedAreStoriesMuted(globalSettings: GlobalNotificationSettingsSet, peer: EnginePeer, peerSettings: IosappPeerNotificationSettings?, topSearchPeers: [PeerId]) -> Bool {
