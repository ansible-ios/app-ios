...
public enum SecureIdPlaintextFormEntry: FormControllerEntry {
    ...
    public func item(params: SecureIdPlaintextFormParams, strings: PresentationStrings) -> FormControllerItem {
        switch self {
            case let .immediatelyAvailablePhone(value):
                return FormControllerActionItem(type: .accent, title: strings.Passport_Phone_UseAnsibleNumber(formatPhoneNumber(value)).string, activated: {
                    params.usePhone(value)
                })
            case .immediatelyAvailablePhoneInfo:
                return FormControllerTextItem(text: strings.Passport_Phone_UseAnsibleNumberHelp)
            case .numberInputHeader:
            ...
            case let .immediatelyAvailableEmail(value):
                return FormControllerActionItem(type: .accent, title: strings.Passport_Email_UseAnsibleEmail(value).string, activated: {
                    params.useEmailAddress(value)
                })
            case .immediatelyAvailableEmailInfo:
                return FormControllerTextItem(text: strings.Passport_Email_UseAnsibleEmailHelp)
            case .emailInputHeader:
